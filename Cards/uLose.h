...
public:
	uLose(sf::RenderWindow* window, sf::Event* event)
	{
		wchar_t word1[20](L"You LOSE!");
		...
		//this->text.setColor(sf::Color::Black);//покрасили текст в красный. если убрать эту строку, то по умолчанию он белый
